...
public final class BombAppetitGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<BombAppetitOuterClass.BombRequest,
      BombAppetitOuterClass.BombResponse> getBombMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Bomb",
      requestType = BombAppetitOuterClass.BombRequest.class,
      responseType = BombAppetitOuterClass.BombResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<BombAppetitOuterClass.BombRequest,
      BombAppetitOuterClass.BombResponse> getBombMethod() {
    io.grpc.MethodDescriptor<BombAppetitOuterClass.BombRequest, BombAppetitOuterClass.BombResponse> getBombMethod;
      ...
      synchronized (BombAppetitGrpc.class) {
        if ((getBombMethod = BombAppetitGrpc.getBombMethod) == null) {
          BombAppetitGrpc.getBombMethod = getBombMethod = 
              io.grpc.MethodDescriptor.<BombAppetitOuterClass.BombRequest, BombAppetitOuterClass.BombResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BombAppetit", "Bomb"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  BombAppetitOuterClass.BombRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  BombAppetitOuterClass.BombResponse.getDefaultInstance()))
  ...
  public static abstract class BombAppetitImplBase implements io.grpc.BindableService {
    ...
    public void bomb(BombAppetitOuterClass.BombRequest request,
        io.grpc.stub.StreamObserver<BombAppetitOuterClass.BombResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                BombAppetitOuterClass.BombRequest,
                BombAppetitOuterClass.BombResponse>(
                  this, METHODID_BOMB)))
          .build();
    }
  }
  ...
  public static final class BombAppetitBlockingStub extends io.grpc.stub.AbstractStub<BombAppetitBlockingStub> {
    ...
    /**
     */
    public BombAppetitOuterClass.BombResponse bomb(BombAppetitOuterClass.BombRequest request) {
  ...
  public static final class BombAppetitFutureStub extends io.grpc.stub.AbstractStub<BombAppetitFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<BombAppetitOuterClass.BombResponse> bomb(
        BombAppetitOuterClass.BombRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_BOMB:
          serviceImpl.bomb((BombAppetitOuterClass.BombRequest) request,
              (io.grpc.stub.StreamObserver<BombAppetitOuterClass.BombResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BombAppetitBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return BombAppetitOuterClass.getDescriptor();
    }
